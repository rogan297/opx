    ...
    *,
    ...
    try:
        ...
        if not default_folder_id:
            # When starter projects are disabled (LANGFLOW_CREATE_STARTER_PROJECTS=false), neither the
            # starter nor the default folder is created at startup for an existing user. Instead of
            # returning a 404 for an empty account, ensure a default folder exists for the current user.
