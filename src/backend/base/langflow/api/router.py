...
from langflow.api.v1 import (
    ...
    operations_action_type_router,
    operations_asset_router,
    operations_customer_router,
    operations_dashboard_router,
    operations_employee_router,
    operations_inventory_router,
    operations_order_router,
    operations_product_router,
    operations_production_order_router,
    operations_standard_router,
    operations_station_router,
    operations_station_queue_router,
    operations_stock_movement_router,
    operations_tenant_router,
    operations_workflow_router,
    operations_workflow_step_router,
    projects_router,
...
router_v1.include_router(operations_tenant_router)
router_v1.include_router(operations_action_type_router)
router_v1.include_router(operations_product_router)
router_v1.include_router(operations_inventory_router)
router_v1.include_router(operations_stock_movement_router)
router_v1.include_router(operations_customer_router)
router_v1.include_router(operations_order_router)
router_v1.include_router(operations_station_router)
router_v1.include_router(operations_station_queue_router)
router_v1.include_router(operations_workflow_router)
router_v1.include_router(operations_workflow_step_router)
router_v1.include_router(operations_production_order_router)
router_v1.include_router(operations_dashboard_router)
router_v1.include_router(operations_employee_router)
router_v1.include_router(operations_asset_router)
router_v1.include_router(operations_standard_router)
