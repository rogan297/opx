...
import DashboardPage from "./pages/OperationsPage/pages/Dashboard";
import ProductsPage from "./pages/OperationsPage/pages/Products";
import StockPage from "./pages/OperationsPage/pages/Stock";
import SuppliersPage from "./pages/OperationsPage/pages/Suppliers";
import ProductionKanbanPage from "./pages/OperationsPage/pages/ProductionKanban";
import StationsPage from "./pages/OperationsPage/pages/Stations";
import WorkflowsPage from "./pages/OperationsPage/pages/Workflows";

import EmployeesPage from "./pages/OperationsPage/pages/Employees";
import InventoryPage from "./pages/OperationsPage/pages/Inventory";
import MaintenancePage from "./pages/OperationsPage/pages/Maintenance";
import MetricsPage from "./pages/OperationsPage/pages/Metrics";
import AiManagerPage from "./pages/OperationsPage/pages/AiManager";
import StandardsPage from "./pages/OperationsPage/pages/Standards";
            ...
            <Route path="" element={<AppAuthenticatedPage />}>
              <Route path="" element={<CustomDashboardWrapperPage />}>
                ...
                <Route path="operations" element={<OperationsPage />}>
                  ...
                  <Route path="production" element={<ProductionKanbanPage />} />
